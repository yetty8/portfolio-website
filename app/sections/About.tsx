...
const aboutItems = [
  {
    ...
    description:
      "Building interactive and accessible interfaces that delight users and improve engagement.",
    impact:
      "Optimized UI responsiveness and accessibility for high user satisfaction.",
    icon: <FaCode className="w-8 h-8 text-blue-600 dark:text-blue-400" />
  },
  {
    title: "Backend Development",
    description:
      "Creating scalable server-side applications with Node.js, Express, and efficient database management.",
    impact:
      "Designed reliable APIs and database structures that handle real-world traffic smoothly.",
    icon: <FaServer className="w-8 h-8 text-green-600 dark:text-green-400" />
  },
  {
    title: "Full-Stack Solutions",
    description:
      "Delivering end-to-end applications that integrate frontend and backend seamlessly.",
    impact:
      "Enabled real-world functionality by connecting interactive UI with robust backend systems.",
      ...
      <div className="container px-6 mx-auto max-w-7xl">
        ...
        >
          ...
          <div className="flex-1">
            ...
            <div className="w-20 h-1 mb-6 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-full" />
            ...
            >
              <p>
                ...
                <strong>modern, scalable, and user-centered web applications</strong>{" "}
                that solve real-world problems. I work with technologies like{" "}
                <strong>React, Next.js, Node.js, and MongoDB</strong> to deliver
                maintainable, high-quality solutions across the full stack.
              </p>

              <p>
                I enjoy transforming complex workflows into intuitive user
                experiences and building reliable backend systems that support
                real-world decision-making. Whether it’s crafting dynamic
                interfaces, designing APIs, or automating processes, I focus on
                creating software that is both practical and impactful.
              </p>

              <p>
                Beyond individual projects, I actively contribute to
                open-source initiatives and enjoy collaborating with developer
                communities to improve tools and workflows. I’m driven by
                continuous learning, problem-solving, and turning ideas into
                products that balance{" "}
                <strong>
                  technical excellence, thoughtful design, and measurable
                  impact
                </strong>.
              </p>
            </motion.div>
